...
export MBEDTLS_LINK="https://tls.mbed.org/download/start/mbedtls-${MBEDTLS_VER}-gpl.tgz"
# SS_LIBEV
...
export SS_LIBEV_YUM_INIT="https://raw.githubusercontent.com/mypal/kcptun_for_ss_ssr/master/ss_libev.init"
export SS_LIBEV_APT_INIT="https://raw.githubusercontent.com/mypal/kcptun_for_ss_ssr/master/ss_libev_apt.init"
# SSR
...
export SSRR_VER=$(wget --no-check-certificate -qO- https://raw.githubusercontent.com/shadowsocksrr/shadowsocksr/akkariiin/master/shadowsocks/version.py | grep return | cut -d\' -f2 | awk '{print $2}')
...
export SSRR_YUM_INIT="https://raw.githubusercontent.com/mypal/kcptun_for_ss_ssr/master/ssrr.init"
export SSRR_APT_INIT="https://raw.githubusercontent.com/mypal/kcptun_for_ss_ssr/master/ssrr_apt.init"
# KCPTUN
export KCPTUN_VER=20201010
...
export KCPTUN_INIT="https://raw.githubusercontent.com/mypal/kcptun_for_ss_ssr/master/kcptun.init"
